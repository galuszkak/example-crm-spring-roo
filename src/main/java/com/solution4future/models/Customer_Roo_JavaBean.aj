...
privileged aspect Customer_Roo_JavaBean {
    ...
    public Set<CustomerAction> Customer.getCustomersActions() {
        return this.customersActions;
    }
    
    public void Customer.setCustomersActions(Set<CustomerAction> customersActions) {
        this.customersActions = customersActions;
    }
